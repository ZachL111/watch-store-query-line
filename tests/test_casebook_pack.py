"""Regression checks for the watch-store-query-line casebook."""
...
from casebook.harness import assert_expected, watch_store_query_line_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_store_query_line_summary(), assert_expected())
